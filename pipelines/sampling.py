...
# from pyskl.utils import from pyskl.utils import warning_r0
...
class UniformSampleFrames:
    ...
    def __init__(self,
        ...
        if len(deprecated_kwargs):
            print('[UniformSampleFrames] The following args has been deprecated: ')
            for k, v in deprecated_kwargs.items():
                print(f'Arg name: {k}; Arg value: {v}')
