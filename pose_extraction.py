...
def parse_args(source_video, output_pickle_name):
    ...
    args = parser.parse_args([source_video, output_pickle_name])
    return args

def video_to_pickle(source_video, output_pickle_name):
    global_args = parse_args(source_video, output_pickle_name)
