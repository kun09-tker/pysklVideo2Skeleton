...
args.det_config = f'{mmdet_root}/configs/swin/mask_rcnn_swin-t-p4-w7_fpn_fp16_ms-crop-3x_coco.py'  # noqa: E501
args.det_checkpoint = 'https://download.openmmlab.com/mmdetection/v2.0/swin/mask_rcnn_swin-t-p4-w7_fpn_fp16_ms-crop-3x_coco/mask_rcnn_swin-t-p4-w7_fpn_fp16_ms-crop-3x_coco_20210908_165006-90a4008c.pth'  # noqa: E501
...
#     # parser.add_argument('label', type=str, help='file txt label each video')
...
def video_to_pickle(index, folder_video, file_label, output_pickle_name, type="avi"):
    ...
    #         anno.append(ntu_pose_extraction(path_video, label[name]))
        ...
        print(f"\n----Done {index*50 + len(anno)} Video----")

        if len(anno) == 50:
            mmcv.dump(anno, f"{output_pickle_name.split('.')[0]}_{index}.pkl")
            index = index + 1
            print(f"\n........................SAVING {index*50} VIDEO FIRST....................\n")
            anno = []
